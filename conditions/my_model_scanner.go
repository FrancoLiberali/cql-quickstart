...
import (
	"database/sql"
	"fmt"
	models "github.com/FrancoLiberali/cql-quickstart/models"
	condition "github.com/FrancoLiberali/cql/condition"
	model "github.com/FrancoLiberali/cql/model"
)

var myModelScanner = &condition.Scanner[models.MyModel]{
	AssignValues: func(dest *models.MyModel, columns []string, values []any) error {
...
func init() {
	condition.RegisterScanner(myModelScanner)
	MyModel.ID = condition.NewField[models.MyModel, model.UUID]("ID", "", "", myModelScanner)
	MyModel.Name = condition.NewStringField[models.MyModel]("Name", "", "", myModelScanner)
}
